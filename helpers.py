"""
Вспомогательный метод для создания заказа и получения его номера из окна подтверждения.
Используется только в тестах Ленты заказов, но использует методы главной стараницы.
За это вынесен отдельно, чтобы не нарушать POM.
"""
